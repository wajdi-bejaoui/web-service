...
public class WebServiceConfiguration extends WsConfigurerAdapter {
    ...
    @Bean(name = "enseignants")
    DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema enseignantSchema) {
		...
		wsdl11Definition.setSchema(enseignantSchema);
		return wsdl11Definition;
	}


    @Bean
    XsdSchema enseignantSchema() {
